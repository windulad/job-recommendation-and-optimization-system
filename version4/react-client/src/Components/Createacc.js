            ...
            <form onSubmit={handleSubmit} class="form-inline"> 
                ...
                <div className="row">
                    <div className="col input_data">
                        ...
                        <input type="text" name='fname' placeholder="First Name" value={fname} onChange={handleFnameChange} required/>
                    </div>
                    <div className="col input_data">
                        <label className="input_label">Last name</label>
                        <input type="text" name='lname' placeholder="Last Name" value={lname} onChange={handleLnameChange} required/>
                    </div>
                </div>
                <div className="row">
                    <div className="col input_data">
                    ...
                    <div className="col input_data">
                        <label className="input_label">Home Address</label>
                        <input type="text" name='address' placeholder="Address" value={address} onChange={handleAddressChange} required/>
                    </div>
                </div>
                <div className="row">
                    <div className="col input_data">
                        <label className="input_label">Postal Code</label>
                        <input type="text" name='postalcode' placeholder="Postalcode" value={postalcode} onChange={handlePostalCodeChange} required/>
                    </div>
                    <div className="col input_data">
                        <label className="input_label">Country</label>
                        <div className="custom_select">
                            <select id="country" name="country" value={selectedCountry} onChange={handleCountryChange} style={{width: '10%', height: '50px'}}>
                ...
                <div className="row">
                    <div className="col signup_login">
