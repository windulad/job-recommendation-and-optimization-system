...
def homepage():
    ...
    # Filter checkbox preparation
    if 'software engineer' in user_positions:
        check1 = True 
    else:
        check1 = False

    if 'front end engineer' in user_positions:
        check2 = True
    else:
        check2 = False

    if 'back end engineer' in user_positions:
        check3 = True 
    else: 
        check3 = False

    if 'android engineer' in user_positions:
        check4 = True
    else:
        check4 = False

    if 'ios engineer' in user_positions:
        check5  = True
    else:
        check5 = False
...
# Homepage submit--------------------------------------
@app.route('/homepagesubmit', methods=['POST','GET'])
@cross_origin(supports_credentials=True)
def homepagesubmit():
    json_data = request.get_json('data')
    ...
    # Get the data from user
    user_id = json_data['value']
    checkbox1 = json_data['checkbox1']
    checkbox2 = json_data['checkbox2']
    checkbox3 = json_data['checkbox3'] 
    checkbox4 = json_data['checkbox4']
    checkbox5 = json_data['checkbox5']
    ...
    # Update table
    cursor.execute("UPDATE positions SET position_1=?,position_2=?,position_3=?,position_4=?,position_5=? WHERE (userid)=? ",(checkbox1,checkbox2,checkbox3,checkbox4,checkbox5,user_id))
